...
function Events() {
  return <div className='mag-top'> Events </div>
}

function Studio() {
  return <div className='mag-top'> Studio </div>
}

function Workshop() {
  return <div className='mag-top'> Workshop </div>
}

function Courses() {
  return <div className='mag-top'> Courses </div>
}

function LearningPaths() {
  return <div className='mag-top'> Learning Paths </div>
}

function User() {
  return <div className='mag-top'> User </div>
}

function About() {
  return <div className='mag-top'> ABOUT</div>
}
