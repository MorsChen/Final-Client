...
export default class App extends React.Component {
  ...
  getToken = (token) => {
    this.setState({token : token, isSignin: true})
  ...
  render() {
    ...
    console.log('check user login', this.state.current_user)
    return (
      <div className="App">
        <Router>
          ...
          <div className="mag-top">
            ...
            <Route path="/login/" component={ (props) => <Login {...props} getToken = {this.getToken} setuser = {(user)=>this.setstate({current_user: user})}/>}/>
