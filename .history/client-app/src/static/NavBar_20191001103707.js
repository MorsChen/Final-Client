...
export default class NavBar extends React.Component {
  constructor(props){
    super(props)
    this.state = {...props}
    console.log('check props Navbar isSignin', this.state.isSignin)
    console.log('check props Navbar Token', this.state.token)
}
...
isSignin = () =>{
  ...
  render () {
    ...
    console.log('check props Navbar isSignin 2', this.isSignin())
      return [
