...
export default class App extends React.Component {
  ...
  render() {
    ...
    console.log('check token login', this.state.isSignin)
    return (
      <div className="App">
        <Router>
          ...
          <div className="mag-top">
            ...
            <Route path="/login/" component={ (props) => <Login {...props} getToken = {this.getToken} setuser = {(user)=>this.setstate({user: user})}/>}/>
