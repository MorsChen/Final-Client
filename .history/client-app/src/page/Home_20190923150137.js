...
export default class CandidatePage extends Component {
    render(){
      return (
        ...
        <Jumbotron className="card-content">
          <div class="flip-card">
              <div class="flip-card-inner">
                <div class="flip-card-front">
                  <img className="imgavt" src="https://images.unsplash.com/photo-1546538994-4f15d0aa966f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&w=1000&q=80" alt="Avatar" style={{width: 200, height: 400}}/>
                  </div>
