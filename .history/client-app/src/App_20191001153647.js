      ...
      <div className="App">
        <Router>
          ...
          <div className="mag-top">
            ...
            <Route path="/profile/create/" comment ={(props)=> <CreateProfile {...props} user = {this.state.user} />}/>
            <Route path="/profile/edit/" comment ={(props)=> <EditProfile {...props} user = {this.state.user} />}/>
